...
PROFILE = default
PROJECT_NAME = big_data_project_lj
...
## Make Dataset
data: requirements
	$(PYTHON_INTERPRETER) src/data/make_dataset.py data/raw/Parking_Violations_Issued_-_Fiscal_Year_2023.csv data/processed/parking_violations_issued_2023.parquet
